        ...
        <>
            <div className="rounded-xl overflow-hidden my-5" id="trackSection">
                ...
                <div className="flex flex-col items-center justify-center sm:flex-row sm:flex-wrap overflow-hidden">
                    ...
                    <StackedCards cardTitle="Education" backgroundImage={Education}> Education was moved online during quarantine causing many to adjust their way of learning for their new environment. As society moves back to learning in-person, how can we help assimilate people back to learning in-person? </StackedCards>
