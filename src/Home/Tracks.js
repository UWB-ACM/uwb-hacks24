...
function Tracks() {
    return (
        <>
            <div className="rounded-xl overflow-hidden mt-5" id="trackSection">
                <div className="font-SecularOne text-6xl text-center mt-3 mb-2">
                    Tracks
                </div>
                
                <div className="flex flex-col items-center justify-center sm:flex-row sm:flex-wrap overflow-hidden pb-36">
